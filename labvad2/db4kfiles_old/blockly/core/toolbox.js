...
Blockly.Toolbox.prototype.init = function() {
  ...
  /******************************************************************/
  /** Modified By RLQ - Call function to toolbox menu intens color **/
  changeMenuItensColor();
  /******************************************************************/
...
/**************************************************************************/
/* Modified By RLQ - This function changes menu intens colors  */
/**************************************************************************/
function changeMenuItensColor(){

		//Captura os elementos de tela cujos atributos serão alterados
		var menuLED=document.getElementById(":2"); //LED
		var textomenuLED = document.getElementById(":2.label"); //TextoLED
		var menuMotores=document.getElementById(":4"); //Motores
		var textomenuMotores= document.getElementById(":4.label"); //TextoMotores
		var menuDisplay=document.getElementById(":6"); //Display
		var textomenuDisplay = document.getElementById(":6.label"); //TextoDisplay
		var menuControle=document.getElementById(":8"); //Controle
		var textomenuControle = document.getElementById(":8.label"); //TextoControle
	
		//Controla as cores do item LED 
		textomenuLED.style.color="white";
		menuLED.style.backgroundColor="#00CD7B";
		menuLED.onmouseover=function(){menuLED.style.backgroundColor="#02A665"};
		menuLED.onmouseout=function(){menuLED.style.backgroundColor="#00CD7B"};
		//Controla as cores do item Motores 
		textomenuMotores.style.color="white";
		menuMotores.style.backgroundColor="#0096CD";
		menuMotores.onmouseover=function(){menuMotores.style.backgroundColor="#027FAC"};
		menuMotores.onmouseout=function(){menuMotores.style.backgroundColor="#0096CD"};
		//Controla as cores do item Display 
		textomenuDisplay.style.color="white";
		menuDisplay.style.backgroundColor="#CD006D";
		menuDisplay.onmouseover=function(){menuDisplay.style.backgroundColor="#AE005D"};
		menuDisplay.onmouseout=function(){menuDisplay.style.backgroundColor="#CD006D "};
		//Controla as cores do item Controle 
		textomenuControle.style.color="white";
		menuControle.style.backgroundColor="#D07D00";
		menuControle.onmouseover=function(){menuControle.style.backgroundColor="#BF6702"};
		menuControle.onmouseout=function(){menuControle.style.backgroundColor="#D07D00"};
