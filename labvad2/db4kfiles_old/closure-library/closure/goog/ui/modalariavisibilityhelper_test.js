...
goog.provide('goog.ui.db4kmodalAriaVisibilityHelperTest');
goog.setTestOnly('goog.ui.db4kmodalAriaVisibilityHelperTest');
 ...
 * @return {!goog.ui.db4kmodalAriaVisibilityHelper}
 */
function createHelper(id) {
  return new goog.ui.db4kmodalAriaVisibilityHelper(goog.dom.getElement(id),
