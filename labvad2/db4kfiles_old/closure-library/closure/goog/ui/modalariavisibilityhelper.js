...
/**
 * @fileoverview Helper object used by db4kmodal elements to control aria
 * visibility of the rest of the page.
 */

goog.provide('goog.ui.db4kmodalAriaVisibilityHelper');
 ...
 * a db4kmodal popup while it is visible.
 *
 ...
 * @constructor
 */
goog.ui.db4kmodalAriaVisibilityHelper = function(element, domHelper) {
  /**
   * @private {!Element}
   */
 ...
 * @private
 */
goog.ui.db4kmodalAriaVisibilityHelper.prototype.hiddenElements_;
 ...
 */
goog.ui.db4kmodalAriaVisibilityHelper.prototype.setBackgroundVisibility = function(
    hide) {
  if (hide) {
