...
goog.provide('goog.ui.db4kmodalPopupTest');
goog.setTestOnly('goog.ui.db4kmodalPopupTest');
...
function testDispose() {
  popup = new goog.ui.db4kmodalPopup();
  popup.render();

  goog.dispose(popup);
  assertNull(goog.dom.getElementByClass('goog-db4kmodalpopup-bg'));
  assertNull(goog.dom.getElementByClass('goog-db4kmodalpopup'));
...
function testRenderWithoutIframeMask() {
  ...
  assertEquals(0, goog.dom.getElementsByTagNameAndClass(
      goog.dom.TagName.IFRAME, 'goog-db4kmodalpopup-bg').length);

  var bg = goog.dom.getElementsByTagNameAndClass(goog.dom.TagName.DIV,
                                                 'goog-db4kmodalpopup-bg');
  assertEquals(1, bg.length);
  var content = goog.dom.getElementByClass('goog-db4kmodalpopup');
...
function testRenderWithIframeMask() {
  popup = new goog.ui.db4kmodalPopup(true);
  popup.render();

  var iframe = goog.dom.getElementsByTagNameAndClass(
      goog.dom.TagName.IFRAME, 'goog-db4kmodalpopup-bg');
...
function testRenderDoesNotShowAnyElement() {
  ...
  assertFalse(goog.style.isElementShown(
      goog.dom.getElementByClass('goog-db4kmodalpopup')));
  var tabCatcher = goog.dom.getElementsByTagNameAndClass(goog.dom.TagName.SPAN);
...
function testIframeOpacityIsSetToZero() {
  ...
  var iframe = goog.dom.getElementsByTagNameAndClass(
      goog.dom.TagName.IFRAME, 'goog-db4kmodalpopup-bg')[0];
