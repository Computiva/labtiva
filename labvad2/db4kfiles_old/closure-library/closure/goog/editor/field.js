...
/**
 * Whether this field is in "db4kmodal interaction" mode. This usually
 * means that it's being edited by a dialog.
 * @type {boolean}
 * @private
 */
goog.editor.Field.prototype.indb4kmodalMode_ = false;
...
/**
 * @return {boolean} Whether we're in db4kmodal interaction mode. When this
 ...
 */
goog.editor.Field.prototype.indb4kmodalMode = function() {
  return this.indb4kmodalMode_;
};


/**
 * @param {boolean} indb4kmodalMode Sets whether we're in db4kmodal interaction mode.
 */
goog.editor.Field.prototype.setdb4kmodalMode = function(indb4kmodalMode) {
  this.indb4kmodalMode_ = indb4kmodalMode;
};
