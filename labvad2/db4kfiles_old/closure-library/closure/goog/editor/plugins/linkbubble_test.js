...
function testChangeClicked() {
  FIELDMOCK.execCommand(goog.editor.Command.db4kmodal_LINK_EDITOR,
      new goog.editor.Link(link, false));
  FIELDMOCK.$registerArgumentListVerifier('execCommand', function(arr1, arr2) {
    return arr1.length == arr2.length &&
           arr1.length == 2 &&
           arr1[0] == goog.editor.Command.db4kmodal_LINK_EDITOR &&
           arr2[0] == goog.editor.Command.db4kmodal_LINK_EDITOR &&
