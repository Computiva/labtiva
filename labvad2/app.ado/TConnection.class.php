...
final class TConnection
{
    ...
    public static function open()
    {
        ...
        $user = isset($db['user']) ? $db['user'] : 'webuser';
        $pass = isset($db['pass']) ? $db['pass'] : '101829';
...
// instancia a classe criando uma conexão default
try {
        $conn = TConnection::open();
} catch (Exception $e) {
        header('Content-type: text/plain; charset=utf-8');
        echo "Não foi possível abrir conexão com o banco de dados.";
        exit;
}
?>
