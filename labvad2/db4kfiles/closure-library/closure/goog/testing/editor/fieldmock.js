...
goog.testing.editor.FieldMock =
  ...
  var indb4kmodalMode = false;

  /**
   * @return {boolean} Whether we're in db4kmodal interaction mode.
   */
  this.indb4kmodalMode = function() {
    return indb4kmodalMode;
  };

  /**
   * @param {boolean} mode Sets whether we're in db4kmodal interaction mode.
   */
  this.setdb4kmodalMode = function(mode) {
    indb4kmodalMode = mode;
  };
