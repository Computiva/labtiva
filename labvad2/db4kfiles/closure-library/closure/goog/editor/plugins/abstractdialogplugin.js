 ...
 * dialog, just when the dialog closes (because only db4kmodal dialogs are
...
goog.editor.plugins.AbstractDialogPlugin.prototype.execCommandInternal =
  ...
  this.getFieldObject().setdb4kmodalMode(true);
  this.dialog_.show();
...
goog.editor.plugins.AbstractDialogPlugin.prototype.handleAfterHide = function(
    e) {
  this.getFieldObject().setdb4kmodalMode(false);
