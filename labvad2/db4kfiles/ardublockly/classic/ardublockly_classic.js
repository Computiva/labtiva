...
/**
 * Displays the IDE output into a db4kmodal overlay.
...
ArdublocklyClassic.loadToArduinoReturn = function(jsonResponse) {
  if (jsonResponse != null) {
    ...
    // edit db4kmodal with new content
    var db4kmodal = document.getElementById('db4kmodal_content');
    db4kmodal.innerHTML = '';
    db4kmodal.appendChild(dataBack);
    // display db4kmodal
    document.getElementById('db4kmodal_toggle').checked = true;
  } else {
    alert('Ardublockly not running locally\n\n' +
